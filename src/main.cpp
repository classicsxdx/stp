...
uint256 hashGenesisBlock("0xfd163c5bcfc9c9003a113937dbdd0e09109cf12329ed89a5036a8eda3e2d2e48");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // StoopidCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "StoopidCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    nSubsidy = 25000 * COIN; //Reward per block
        }
...
static const int64 nTargetTimespan = 30;  // StoopidCoin: every block
static const int64 nTargetSpacing = 30;  // StoopidCoin: 30 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal StoopidCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StoopidCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "April 1st, 2014 9AM EST";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x001a5af59c5425e63a879772e874ae06588e47f93104a812ae3e54cb79dec938"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // StoopidCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
